...
$(document).ready(function() {
	...
	table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('backend/daftarPrestasi/loadTable')?>",
            "type": "POST"
        },
...
$(document).on("click","#statusDaftarUlang",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/daftarPrestasi/updateStatusDaftarUlang');?>"+'/'+id+'/'+ind,
			data: id,
...
$(document).on("click","#statusValidasi",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/daftarPrestasi/updateStatusValidasi');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				load();
...
function save()
{
    ...
    var url = "<?php echo site_url('backend/daftarPrestasi/save')?>";
...
function inputNilai(idPendaftar){
	...
	$.ajax({
        url : "<?php echo site_url('backend/daftarPrestasi/getNilaiTes')?>/" + idPendaftar,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function simpanNilai(){
	...
	if(error == false){
		var url = "<?php echo site_url('backend/daftarPrestasi/saveNilai')?>";
		$("#msgSKS").text("Data Berhasil Ditambah !!");
		$("#msgERR").text("Data Gagal Ditambah !!");
              ...
              <div class="col-md-6">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <form action="<?=base_url();?>backend/daftarPrestasi/upload" method="post" class="form-horizontal" enctype="multipart/form-data">		
                                        <div class="form-body">
                                            <div class="form-group">
