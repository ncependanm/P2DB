    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">		
        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                <div class="page-logo" style="background: #FFF !important">
                    <a href="<?=base_url();?>backend/beranda">
						<img src="<?=base_url();?>assets/images/logoP2DB.jpeg" width="30%" alt="" />
					</a>
                                ...
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <span class="username username-hide-on-mobile">
										<?php if($this->session->userdata('level') == 1){
											...
											echo $this->session->userdata('nama_akun');
										}?>
									</span>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2016 &copy; Encep Endan M (Tahun Ajaran : <?=$this->session->userdata('nama_thn_ajaran')?>  - Semester : <?=$this->session->userdata('nama_semester')?>)
