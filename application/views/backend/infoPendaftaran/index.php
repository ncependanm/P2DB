	...
	$("#dataView").show();
        ...
        success: function(data)
        {
			...
			if(data.dataPrestasiDua.reg_data_prestasi_indek == '2'){
					...
					$('[name="dataPrestasiJuaraDua"]').text(data.dataPrestasiDua.reg_data_prestasi_juara);
			...
			if(data.dataPrestasiTiga.reg_data_prestasi_indek == '3'){
					...
					$('[name="dataPrestasiJuaraTiga"]').text(data.dataPrestasiTiga.reg_data_prestasi_juara);
...
$(document).on("click","#statusKelulusan",function(){
	var id=$(this).attr("data-id");
	var ind=$(this).attr("data-ind");
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/infoPendaftaran/updateStatusKelulusan');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				load();
				$("#msgSKS").text("Status Kelulusan Berhasil Diubah !!");
				$("#alerSKS").show();
			} ,
			error: function ()
			{
				$("#msgERR").text("Status Kelulusan Gagal Diubah !!");
				$("#alerERR").show();
			}
		 });
	});
...
$(document).on("click","#statusPindahJalur",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/infoPendaftaran/updateJalurDaftar');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				window.location = "<?php echo site_url('backend/login/logout');?>";
			} ,
			error: function ()
			{
...
function uploadKelulusan(){
	reset();
	$('#uploadKelulusan').show();
}
                        ...
                        <div class="col-md-12">
							...
							<?php } ?>
								...
								<div class="portlet-title" style="border-bottom: none !important;">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="uploadKelulusan();">Upload Kelulusan</button>
                                    ...
                                    <table id="table" class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="all">Status Kelulusan</th>
...
<select class="form-control" name="reg_data_ortu_penghasilan_w">
              ...
              <div class="col-md-6">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <form action="<?=base_url();?>backend/infoPendaftaran/uploadFoto" method="post" class="form-horizontal" enctype="multipart/form-data">		
                                        <div class="form-body">
      ...
      <div class="row" id="uploadKelulusan" style="display: none;">
              <div class="col-md-6">
                            <!-- BEGIN EXAMPLE TABLE PORTLET-->
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <span class="caption-subject bold uppercase">Upload Data Kelulusan Calon Siswa</span>
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                <div class="portlet-body">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <form action="<?=base_url();?>backend/infoPendaftaran/uploadKelulusan" method="post" class="form-horizontal" enctype="multipart/form-data">		
                                        <div class="form-body">
                                            <div class="form-group">
												...
												<a href="<?=base_url()?>templateUpload/template-kelulusan.xls">Download Template</a></br>
