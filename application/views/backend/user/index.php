                        ...
                        <div class="col-md-12 page-404">
                            ...
                            <div class="details">
                                ...
                                <p> Maaf, anda tidak dapat mengakses halaman ini.
                                    <br>
                                    <a href="index.html"> Kembali kke dashboard </a></p>
                            </div>
                        </div>
                    </div>
<?php }else{ ?>
...
function getComboUbah(selectObject) {
var value = selectObject.value;
    if(value == 'Y'){
		...
		$('#tmpPass').hide();
		$('[name="user_password"]').val(passLama);
    }
}
                                ...
                                <div class="portlet-body">
                                    ...
                                    <form id="form" class="form-horizontal" autocomplete="off">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-5">Username
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-7">
											...
											<div class="form-group" id="tmpPassEdit">
                                                <label class="control-label col-md-5">Ubah Password
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-7">
                                                    <select class="form-control" name="ubah_pass" onchange="getComboUbah(this)">
                                            ...
                                            <div class="form-group" id="tmpPass">
