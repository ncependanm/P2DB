...
$(document).ready(function() {
	...
	table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('backend/infoPendaftaranReg/loadTable')?>",
            "type": "POST"
        },
...
function lihat(idPendaftar) {
	...
	$("#dataView").show();
	    $.ajax({
        url : "<?php echo site_url('backend/infoPendaftaranReg/getDataNew')?>/" + idPendaftar,
        type: "GET",
        dataType: "JSON",
...
$(document).on("click","#statusDaftarUlang",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/infoPendaftaranReg/updateStatusDaftarUlang');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				load();
...
$(document).on("click","#statusValidasi",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/infoPendaftaranReg/updateStatusValidasi');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				load();
...
function inputNilai(idPendaftar){
	...
	$.ajax({
        url : "<?php echo site_url('backend/infoPendaftaranReg/getNilaiTes')?>/" + idPendaftar,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function simpanNilai(){
	...
	if(error == false){
		var url = "<?php echo site_url('backend/infoPendaftaranReg/saveNilai')?>";
              ...
              <div class="col-md-6">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <form action="<?=base_url();?>backend/infoPendaftaranReg/uploadFoto" method="post" class="form-horizontal" enctype="multipart/form-data">		
                                        <div class="form-body">
