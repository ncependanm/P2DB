...
$(document).ready(function() {
	...
	table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('backend/nilaiPendaftaranReg/loadTable')?>",
            "type": "POST"
        },
...
$(document).on("click","#statusDaftarUlang",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/nilaiPendaftaranReg/updateStatusDaftarUlang');?>"+'/'+id+'/'+ind,
			data: id,
...
$(document).on("click","#statusValidasi",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/nilaiPendaftaranReg/updateStatusValidasi');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				load();
...
function save()
{
    ...
    var url = "<?php echo site_url('backend/nilaiPendaftaranReg/save')?>";
...
function inputNilai(idPendaftar){
	...
	$.ajax({
        url : "<?php echo site_url('backend/nilaiPendaftaranReg/getNilaiTes')?>/" + idPendaftar,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function simpanNilai(){
	...
	if(error == false){
		var url = "<?php echo site_url('backend/nilaiPendaftaranReg/saveNilai')?>";
		$("#msgSKS").text("Data Berhasil Ditambah !!");
		$("#msgERR").text("Data Gagal Ditambah !!");
                                    ...
                                    <table id="table" class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="all">Nilai Tes Tulis</th>
                                                <th class="all">Nilai SKHU</th>
              ...
              <div class="col-md-6">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <form action="<?=base_url();?>backend/nilaiPendaftaranReg/upload" method="post" class="form-horizontal" enctype="multipart/form-data">		
                                        <div class="form-body">
                                            <div class="form-group">
