...
$(document).ready(function() {
	...
	table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('backend/infoPendaftaranRegPrestasi/loadTable')?>",
            "type": "POST"
        },
...
function lihat(idPendaftar) {
	...
	$("#dataView").show();
	    $.ajax({
        url : "<?php echo site_url('backend/infoPendaftaranRegPrestasi/getDataNew')?>/" + idPendaftar,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
			...
			if(data.dataAkun.reg_akun_jalur_daftar == 'P'){
				$("#peringkatTmp").show();
			} else {
				$("#skhuTmp").show();
			}
			$('[name="dataNilaiSkhuMtk"]').text(data.dataSkhu.reg_data_nilai_skhu_mtk);
			$('[name="dataNilaiSkhuInd"]').text(data.dataSkhu.reg_data_nilai_skhu_ind);
			$('[name="dataNilaiSkhuIng"]').text(data.dataSkhu.reg_data_nilai_skhu_ing);
			$('[name="dataNilaiSkhuIpa"]').text(data.dataSkhu.reg_data_nilai_skhu_ipa);
...
$(document).on("click","#statusDaftarUlang",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/infoPendaftaranRegPrestasi/updateStatusDaftarUlang');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				load();
...
$(document).on("click","#statusValidasi",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			url:"<?php echo site_url('backend/infoPendaftaranRegPrestasi/updateStatusValidasi');?>"+'/'+id+'/'+ind,
			data: id,
			success: function(data){
				load();
...
function inputNilai(idPendaftar){
	...
	$.ajax({
        url : "<?php echo site_url('backend/infoPendaftaranRegPrestasi/getNilaiTes')?>/" + idPendaftar,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function simpanNilai(){
	...
	if(error == false){
		var url = "<?php echo site_url('backend/infoPendaftaranRegPrestasi/saveNilai')?>";
...
function downloadRekap(){
	var pop = window.open("<?=base_url()?>/laporanRekapitulasi");
	window.setTimeout(function(){
		pop.close();
	}, 3000);
}

function showUploadFoto(id, nisn){
	reset();
	showLoading();
	$('#uploadFoto').show();
    $('[name="idN"]').val(id);
                        ...
                        <div class="col-md-12">
							...
							<?php } ?>
								...
								<div class="portlet-title" style="border-bottom: none !important;">
									...
									<!--<a href="#" class="btn btn-primary" onclick="downloadRekap();">Laporan Rekapitulasi</a>-->
                                </div>
							...
							<form class="form-horizontal" autocomplete="off">
								<div class="form-body">
									...
									<div class="row static-info col-md-12">
										...
										<div class="col-md-10">
											<p class="form-control-static value" name="dataNilaiSkhuMtk"></p>
										</div>
										<label class="control-label col-md-2 name">Bahasa Indonesia :</label>
										<div class="col-md-10">
											<p class="form-control-static value" name="dataNilaiSkhuInd"></p>
										</div>
										<label class="control-label col-md-2 name">Bahasa Inggris :</label>
										<div class="col-md-10">
											<p class="form-control-static value" name="dataNilaiSkhuIng"></p>
										</div>
										<label class="control-label col-md-2 name">IPA :</label>
										<div class="col-md-10">
											<p class="form-control-static value" name="dataNilaiSkhuIpa"></p>
										</div>
									</div>
									</div>
                                                ...
                                                <ul class="nav nav-pills nav-justified steps">
                                                    ...
                                                    <li>
                                                        <a href="#tab3" data-toggle="tab" class="step active">
                                                            ...
                                                            <span class="desc">
                                                                <i class="fa fa-check"></i> Data Nilai SKHUN </span>
                                                        </a>
                                                    </li>
                                                    <li>
...
<select class="form-control" name="reg_data_ortu_penghasilan_w">
                                                    ...
                                                    <div class="tab-pane" id="tab3">
                                                        <h3 class="block">Lengkapi Data Nilai SKHUN</h3>
                                                        <div class="col-md-12">
															<div class="col-md-6">
																<div class="form-group">
              ...
              <div class="col-md-6">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <!-- BEGIN FORM-->
                                    <form action="<?=base_url();?>backend/infoPendaftaranRegPrestasi/uploadFoto" method="post" class="form-horizontal" enctype="multipart/form-data">		
                                        <div class="form-body">
											<input type="text" name="idN" hidden/>
											<input type="text" name="nisn" hidden/>
											<div class="form-group">
