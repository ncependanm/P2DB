            ...
            <div class="row" style="margin-bottom:5px !important;">
                <div class="col-md-6 coming-soon-header">
                    <a class="brand" href="index.html" style="border-radius: 5px">
                        <img src="<?=base_url();?>assets/images/logoP2DB.jpeg" alt="logo" width="50%"/>
					</a>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 coming-soon-content" >
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-title" id="tempatDaftar">
...
<![endif]-->
		...
		$(document).ready(function() {	
			...
			if(today >= tglAwalReg){
				...
				if(today < tglAkhirReg && today > tglAkhir){
					austDayReg = new Date(tahunRegAwal);
					$('#defaultCountdown').hide();
