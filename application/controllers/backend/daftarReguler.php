<?php
class daftarReguler extends CI_Controller{
    
    var $folder =   "backend/daftarReguler";
	...
	{	
		$list = $this->daftarRegulerModel->get_datatables('R');
		$data = array();
		$no = 0;
		$jalurDaftar = "";
		$status = "";
		...
		$output = array(
						"draw" => $_POST['draw'],
						"recordsTotal" => $this->daftarRegulerModel->count_all('R'),
						"recordsFiltered" => $this->daftarRegulerModel->count_filtered('R'),
						"data" => $data,
				);
