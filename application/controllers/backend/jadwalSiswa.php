...
class jadwalSiswa extends CI_Controller{
    ...
    var $folder =   "backend/jadwalSiswa";
    ...
    function index()
    {
		...
		$sql = "SELECT * FROM tbl_jadwal_pelajaran tjp 
				...
				JOIN tbl_kelas_siswa_tmp tks ON(tr.ruangan_id = tks.kelas_siswa_tmp_ruangan_id)  
				WHERE kelas_siswa_tmp_siswa_id = ". $this->session->userdata('id_akun') ." 
