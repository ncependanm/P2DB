...
class Mata_Pelajaran_Model extends CI_Model {
	...
	var $table = 'tbl_mata_pelajaran';
	var $column_order = array('mata_pelajaran_id','mata_pelajaran_nama',null); //set column field database for datatable orderable
	...
	var $order = array('mata_pelajaran_id' => 'asc'); // default order 
